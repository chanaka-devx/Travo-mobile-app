...
class _AiChatPageState extends State<AiChatPage> {
  ...
  final List<ChatMessage> _messages = [
    ...
    ChatMessage(
      text: "Yes, definitely! I want to visit some beaches and maybe see some wildlife.",
      isUser: true,
          ...
          Flexible(
            child: Column(
              ...
              children: [
                ...
                // Quick Action Icons for AI messages
                if (!message.isUser)
                  Padding(
